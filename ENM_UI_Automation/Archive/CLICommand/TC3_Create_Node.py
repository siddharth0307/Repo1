...
# Actual Test
    ...
    def test_4_click_CLI(self):
        ...
        # print("Command is about to execute")
        # time.sleep(10)
        # print("Command is about to execute")
        # driver.find_element_by_css_selector("#cliInput").send_keys("Hi")
        # time.sleep(5)
        print("Execute button will be clicked.")
        driver.find_element_by_xpath("//div[@class='eaCliApp-cliInputWidget-inputPrompt-inner']").click()
        time.sleep(10)
